...
/**
 * <h2>UserCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity User.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/UserCommand")
public class UserCommandRestController extends BaseSpringRestController {

	public UserCommandRestController( UserService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a User.
     * @param		User	user
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID userId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(UserCommandRestController.class.getName());
