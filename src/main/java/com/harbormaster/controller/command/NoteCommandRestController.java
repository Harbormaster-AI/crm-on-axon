...
/**
 * <h2>NoteCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity Note.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/NoteCommand")
public class NoteCommandRestController extends BaseSpringRestController {

	public NoteCommandRestController( NoteService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a Note.
     * @param		Note	note
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID noteId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(NoteCommandRestController.class.getName());
