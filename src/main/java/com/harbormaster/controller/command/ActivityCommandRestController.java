...
/**
 * <h2>ActivityCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity Activity.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/ActivityCommand")
public class ActivityCommandRestController extends BaseSpringRestController {

	public ActivityCommandRestController( ActivityService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a Activity.
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID activityId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(ActivityCommandRestController.class.getName());
