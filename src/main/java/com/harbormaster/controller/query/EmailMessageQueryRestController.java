...
/**
 * <h2>EmailMessageQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity EmailMessage.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class EmailMessageQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public EmailMessage load( @RequestParam(required=true) UUID emailMessageId ) {
    ...
    public List<EmailMessage> loadAll() {                
    	...
    	try {
            ...
            LOGGER.log( Level.WARNING,  "failed to load all EmailMessages ", exc );
        	return null;
        }
