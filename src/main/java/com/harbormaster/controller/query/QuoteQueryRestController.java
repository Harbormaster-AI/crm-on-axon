...
/**
 * <h2>QuoteQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity Quote.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class QuoteQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public Quote load( @RequestParam(required=true) UUID quoteId ) {
    	Quote entity = null;
