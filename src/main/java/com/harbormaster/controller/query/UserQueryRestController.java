...
/**
 * <h2>UserQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity User.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class UserQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public User load( @RequestParam(required=true) UUID userId ) {
    	User entity = null;
